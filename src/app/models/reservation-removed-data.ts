import { Reservation } from './Reservation';
  ...
  export const ReservationsRemoved2: Reservation[] = [
      { id: 1, price: 99.99, date: '15-11-2017', products: [
        { id: 1, name: 'Narty', src: '/assets/img/skis/big_a48c82e99ec94d4d967ff56b84e2bb50.jpg', price: 99.99, size: 170,
          info: 'Narty idealne do ...'}
       ]}
  ]

  export const ReservationsRemoved1: Reservation[] = [
    { id: 2, price: 229.98, date: '19-12-2017', products: [
